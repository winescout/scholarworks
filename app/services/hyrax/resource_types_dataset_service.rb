module Hyrax
  module ResourceTypesDatasetService
    mattr_accessor :authority
    self.authority = Qa::Authorities::Local.subauthority_for('resource_types_dataset')
    ...
    def self.microdata_type(id)
      ...
      Microdata.fetch("resource_type_dataset.#{id}", default: Hyrax.config.microdata_default_type)
    end
  end
end
